const IngestionStartError = (props) => {
  ...
  return (
    <div
      className={`w-40 h-24 px-4 py-4 text-blackTextLight dark:text-white text-sm absolute right-0 md:right-20 xl:right-40 top-10 bg-cardLight dark:bg-cardDark ${
    ...
    >
      <div
        ...
        border-b-[20px] border-b-cardLight dark:border-b-cardDark
